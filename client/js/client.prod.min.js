...
if("function"==typeof f)try{if(0===f("0")&&!f(!1)){d=f('{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}');var p=5==d.a.length&&1===d.a[0];if(p){try{p=!f('"\t"')}catch(l){}if(p)try{p=1!==f("01")}catch(e){}if(p)try{p=1!==f("1.")}catch(n){}}}}catch(B){p=!1}f=p}}return c[b]=!!f}var g={}.toString,d,h,u,s="object"==typeof JSON&&JSON,a="object"==typeof e&&e&&!e.nodeType&&e;a&&s?(a.stringify=s.stringify,a.parse=s.parse):a=b.JSON=s||{};var y=new Date(-0xc782b5b800cec);try{y=-109252==y.getUTCFullYear()&&
...
case 8:return a.e.lc(b);default:return null}},parseBindingsString:function(b,c,d,e){try{var g=this.Nb,h=b+(e&&e.valueAccessors||""),n;if(!(n=g[h])){var q,k="with($context){with($data||{}){return{"+a.g.qa(b,e)+"}}}";q=new Function("$context","$element",k);n=g[h]=q}return n(c,d)}catch(p){throw p.message="Unable to parse bindings.\nBindings value: "+b+"\nMessage: "+p.message,p;}}});a.J.instance=new a.J})();a.b("bindingProvider",a.J);(function(){function d(a){return function(){return a}}function e(a){return a()}

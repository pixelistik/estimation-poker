...
client/js/client.prod.js: node_modules/socket.io/node_modules/socket.io-client/dist/socket.io.js client/js/lib/knockout-debug.js client/js/tools.js client/js/models.js client/js/bindings.js client/js/app.js
	# Concatenate JS
	cat node_modules/socket.io/node_modules/socket.io-client/dist/socket.io.js client/js/lib/qrcode.min.js client/js/lib/knockout-debug.js client/js/tools.js client/js/models.js client/js/bindings.js client/js/app.js > client/js/client.prod.js
